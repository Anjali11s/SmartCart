...
<head>
    ...
    <title>Edit Product - SmartCart</title>
                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @if($product->quantity <= 5 && $product->quantity > 0)
                            <small class="text-yellow-600 mt-1 block">⚠️ Low stock! Consider restocking soon.</small>
                        @elseif($product->quantity == 0)
                            <small class="text-red-600 mt-1 block">❌ Out of stock! Update quantity to make it available.</small>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        <input type="file" name="image" id="image" accept="image/*" class="form-control" style="padding: 0.5rem; margin-top: 0.5rem;">
                        <small class="text-gray-500 mt-1 block">Leave empty to keep current image. Accepted formats: JPEG, PNG, JPG (Max: 2MB)</small>
                    </div>
